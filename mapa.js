...
const unidades = [
    {
        ...
        lat: -24.945937321003502,  // Latitude - Cascavel/PR
        lng: -53.483513567762046,  // Longitude - Cascavel/PR
        endereco: 'Rua Natal, 2800<br>Bairro Tropical, Cascavel/PR',
        telefone: '+5545 99999 8888',
        horario: 'Seg-Sex: 8h-18h | Sáb: 8h-14h',
        descricao: 'Nossa unidade principal em Cascavel, Paraná.'
    },
    {
        id: 'unidade2',
        nome: 'Unidade Parque Verde',
        lat: -24.93689846095886,
        lng: -53.493428904559885,
        endereco: 'Rua Angelim, 630<br>Parque Verde - Cascavel/PR',
        telefone: '+5541888887777',
        horario: 'Seg-Sex: 9h-19h | Sáb: 9h-15h',
        descricao: 'Unidade para aulas particulares.'
    }
...
class MapaInterativo {
    ...
    init() {
        ...
        this.mapa = L.map('mapa').setView([-24.945937321003502, -53.483513567762046], 13);
